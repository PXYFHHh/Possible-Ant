...
LEVEL_1_CHUNK_OVERLAP = int(os.getenv("RAG_LEVEL_1_CHUNK_OVERLAP", "120"))
LEVEL_2_CHUNK_SIZE = int(os.getenv("RAG_LEVEL_2_CHUNK_SIZE", "600"))
LEVEL_2_CHUNK_OVERLAP = int(os.getenv("RAG_LEVEL_2_CHUNK_OVERLAP", "60"))
LEVEL_3_CHUNK_SIZE = int(os.getenv("RAG_LEVEL_3_CHUNK_SIZE", "300"))
LEVEL_3_CHUNK_OVERLAP = int(os.getenv("RAG_LEVEL_3_CHUNK_OVERLAP", "30"))
