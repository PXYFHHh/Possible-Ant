...
LEVEL_1_CHUNK_SIZE = int(os.getenv("RAG_LEVEL_1_CHUNK_SIZE", "2000"))
LEVEL_1_CHUNK_OVERLAP = int(os.getenv("RAG_LEVEL_1_CHUNK_OVERLAP", "400"))
LEVEL_2_CHUNK_SIZE = int(os.getenv("RAG_LEVEL_2_CHUNK_SIZE", "1000"))
LEVEL_2_CHUNK_OVERLAP = int(os.getenv("RAG_LEVEL_2_CHUNK_OVERLAP", "200"))
